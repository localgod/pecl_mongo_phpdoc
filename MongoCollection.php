...
class MongoCollection {
	 ...
	 * 
	 * @param boolean $scan_data Only validate indices, not the base collection. 
	 * 
	 * @return array
	 */
	 ...
	 * @param array $options  Options for update. 
	 * 
	 * @return boolean
	 */
	 ...
	 * @param integer $limit Specifies an upper limit to the number returned. 
	 * @param integer $skip  Specifies a number of results to skip before starting the count.
	 * 
	 * @return integer
	 */
	 ...
	 * 
	 * @param mixed     $keys    Fields to group by. If an array or non-code object 
	 *                           is passed, it will be the key used to group results. 
	 * @param array     $initial Initial value of the aggregation counter object. 
	 * @param MongoCode $reduce  A function that takes two arguments (the current 
