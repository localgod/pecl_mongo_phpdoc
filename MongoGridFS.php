...
class MongoGridFS extends MongoCollection {
	 ...
	 * @param array $options  Options for the remove. Valid options are: "safe". Check that the remove succeeded.
	 * 
	 * @return boolean
	 */
	 ...
	 * @param string $filename An array of extra fields for the uploaded file. 
	 * 
	 * @return mixed
	 */
