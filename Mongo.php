...
class Mongo {
	 ...
	 * 
	 * @param integer $size The max number of connections future pools will be able to create. 
	 ...
	 * 
	 * @param boolean $ok If reads should be sent to secondary members of a replica set 
